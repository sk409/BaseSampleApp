...
class SlideMenuSectionView: UIStackView {
    
    let iconImageView = UIImageView()
    let titleLabel = UILabel()
    
    private var itemsContainerViewHeightConstraint: NSLayoutConstraint?
    private var headerView: SlideMenuSectionHeaderView?
    private let itemsContainerView = SlideMenuSectionItemsContainerView()
    ...
    func set(
        headerView: SlideMenuSectionHeaderView?,
        height: CGFloat
    ) {
    ...
    func append(
        menuItemView: SlideMenuItemView,
        height: CGFloat
    ) {
